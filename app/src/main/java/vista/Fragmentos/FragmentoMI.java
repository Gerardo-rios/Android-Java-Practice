    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.btn_guardar_frg:
                try {
                    OutputStreamWriter escritor = new OutputStreamWriter(getActivity().openFileOutput("archivitoVersdugo.txt", Context.MODE_APPEND));
            ...
            case R.id.btn_buscarTodos_frg:
                try {
                    ...
                    BufferedReader lector = new BufferedReader(new InputStreamReader(getActivity().openFileInput("archivitoVersdugo.txt")));
