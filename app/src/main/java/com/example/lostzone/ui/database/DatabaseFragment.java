package com.example.lostzone.ui.database;
...
public class DatabaseFragment extends Fragment implements View.OnClickListener{
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        orm = getActivity().findViewById(R.id.btn_btnorm);
        helper = getActivity().findViewById(R.id.btn_btnhelper);
        orm.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.btn_btnhelper:
                intencion = new Intent(getContext(), ProductoHelper.class);
                startActivity(intencion);
                break;
            case R.id.btn_btnorm:
                intencion = new Intent(getContext(), ORM.class);
                startActivity(intencion);
                break;
